...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypmml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13299&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypmml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypmml` can be installed with:

```
conda install pypmml
```

It is possible to list all of the versions of `pypmml` available on your platform with:
